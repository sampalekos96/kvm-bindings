...
#[test]
fn bindgen_test_layout_kvm_vmx_nested_state__bindgen_ty_1() {
    assert_eq!(
        ::std::mem::size_of::<kvm_vmx_nested_state__bindgen_ty_1>(),
        2usize,
        concat!("Size of: ", stringify!(kvm_vmx_nested_state__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_vmx_nested_state__bindgen_ty_1>(),
        2usize,
        concat!(
            "Alignment of ",
            stringify!(kvm_vmx_nested_state__bindgen_ty_1)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_vmx_nested_state__bindgen_ty_1>())).flags as *const _
                as usize
        },
        0usize,
        concat!(
...
#[test]
fn bindgen_test_layout_kvm_vmx_nested_state() {
    assert_eq!(
        ::std::mem::size_of::<kvm_vmx_nested_state>(),
        24usize,
        concat!("Size of: ", stringify!(kvm_vmx_nested_state))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_vmx_nested_state>(),
        8usize,
        concat!("Alignment of ", stringify!(kvm_vmx_nested_state))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_vmx_nested_state>())).vmxon_pa as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_vmx_nested_state),
            "::",
            stringify!(vmxon_pa)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_vmx_nested_state>())).vmcs_pa as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_vmx_nested_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<kvm_vmx_nested_state>())).smm as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_vmx_nested_state),
...
pub struct kvm_nested_state {
    ...
    pub format: __u16,
    pub size: __u32,
    pub __bindgen_anon_1: kvm_nested_state__bindgen_ty_1,
